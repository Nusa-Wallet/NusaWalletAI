    ...
    return pa.DataFrameSchema(
        {
            ...
            "hour_sin": pa.Column(float, pa.Check.in_range(-1.0, 1.0)),
            "hour_cos": pa.Column(float, pa.Check.in_range(-1.0, 1.0)),
            ...
            "duplicate_similarity": pa.Column(float, pa.Check.in_range(0.0, 1.0)),
            ...
            "payer_name_quality": pa.Column(float, pa.Check.in_range(0.0, 1.0)),
